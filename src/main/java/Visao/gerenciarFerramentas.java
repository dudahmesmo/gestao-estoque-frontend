...
public class gerenciarFerramentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TabelaFerramentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Ferramenta", "Marca", "Custo de Aquisição (R$)", "Disponível" 
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Long idFerramenta = (Long) TabelaFerramentas.getValueAt(rowIndex, 0);

        if (ferramentasControle.deletarFerramenta(idFerramenta.intValue())) { 
