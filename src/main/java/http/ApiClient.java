...
public class ApiClient {
    ...
    public List<Map<String, Object>> listarCategoriasCompletas() throws
        ...
        Type tipolistaCategorias = new TypeToken<List<Map<String,
                Object>>>() {}.getType();
    ...
    // MÉTODOS DE LISTAGEM DE EMPRÉSTIMOS
    
    // Lista Empréstimos Ativos (
    public List<Emprestimos> listarEmprestimosAtivos () throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    // Lista Devedores (para Relatório)
